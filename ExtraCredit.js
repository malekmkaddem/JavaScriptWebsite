...
if (!isValid){
    evt.preventDefault();
        ...
        $("#result1").textContent =  euro.toFixed(2) + " Euro(s)";
        $("#result2").textContent =  canadian.toFixed(2) + " Canadian Dollar(s)";
        $("#result3").textContent =  honkong.toFixed(2) + " Honkong Dollar(s)";
        $("#result4").textContent =  japan.toFixed(2) + " Yen";
        $("#result5").textContent =  mexican.toFixed(2) + " Peso(s)";
    }
